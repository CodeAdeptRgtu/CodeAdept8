    ...
    <div className='gallery'>
      ...
      <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme skill-slider">
        <div className="winner-detail">
          ...
          <h5>Abhay Tripathi(3rd)</h5>
          <p>IT- 3rd Year (7.0)</p>
        </div>
        <div className="winner-detail">
          <img src={img1} alt="Image" />
          <h5>Aditi Agrawal(1st)</h5>
          <p>CSE- 4th Year (7.0)</p>
        </div>
        <div className="winner-detail">
          <img src={img2} alt="Image" />
          <h5>Arpit Pathak(2nd)</h5>
          <p>CSE- 2nd Year (7.0)</p>
        </div>

        <div className="winner-detail">
          <img src={img10} alt="Image" />
          <h5>Jayant Patel</h5>
          <p>1nd Runner Up (6.0)</p>
        </div>
        <div className="winner-detail">
        ...
        <div className="winner-detail">
          ...
          <p>2nd Runner Up (6.0)</p>
        </div>

        <div className="winner-detail">
          <img src={img7} alt="Image" />
          <h5>Anshuman Prajapati</h5>
          <p>2nd Runner Up (5.0)</p>
        </div>
        <div className="winner-detail">
        ...
        <div className="winner-detail">
          ...
          <p>1st Runner Up (5.0)</p>
        </div>

        <div className="winner-detail">
          <img src={img5} alt="Image" />
          <h5>Anjali Chauhan(1st)</h5>
          <p>CSE- 2nd Year (4.0)</p>
        </div>
        <div className="winner-detail">
          <img src={img4} alt="Image" />
          <h5>Hritik Kumar(2nd)</h5>
          <p>CSE- 3rd Year (4.0)</p>
        </div>
        <div className="winner-detail">
          <img src={img6} alt="Image" />
          <h5>Ansh Shrivastava(3rd)</h5>
          <p>IT- 3rd Year (4.0)</p>
        </div>
      </Carousel>
      </div>
